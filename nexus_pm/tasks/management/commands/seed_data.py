...
from tasks.models import BugReport, CalendarEvent, Notification, Project, Task
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        tasks_data = [
            # PCB Project
            {
                "title": "Schematic review for power supply section",
                "project": pcb,
                "status": "done",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Component selection for MCU",
                "project": pcb,
                "status": "done",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "PCB layout - layer stackup definition",
                "project": pcb,
                "status": "in_progress",
                "priority": "critical",
                "task_type": "task",
            ...
            {
                "title": "EMC compliance checklist",
                "project": pcb,
                "status": "todo",
                "priority": "medium",
                "task_type": "task",
            ...
            {
                "title": "Prototype board ordering",
                "project": pcb,
                "status": "todo",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Voltage regulator output noise fix",
                "project": pcb,
                "status": "in_progress",
                "priority": "critical",
                "task_type": "bug",
                ...
                "estimated_hours": 8,
                "tags": "power,analog,urgent",
            },
            # Firmware Project
            {
                "title": "Define OTA update protocol spec",
                "project": fw,
                "status": "done",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Implement HTTPS download handler",
                "project": fw,
                "status": "in_progress",
                "priority": "critical",
                "task_type": "feature",
            ...
            {
                "title": "Flash write & verify routine",
                "project": fw,
                "status": "todo",
                "priority": "critical",
                "task_type": "feature",
            ...
            {
                "title": "Rollback mechanism on failed update",
                "project": fw,
                "status": "todo",
                "priority": "high",
                "task_type": "feature",
            ...
            {
                "title": "Unit tests for OTA module",
                "project": fw,
                "status": "todo",
                "priority": "medium",
                "task_type": "task",
            ...
            {
                "title": "Memory overflow on large firmware chunks",
                "project": fw,
                "status": "in_progress",
                "priority": "critical",
                "task_type": "bug",
            ...
            # Mechanical Project
            {
                "title": "CAD model of enclosure v1",
                "project": mech,
                "status": "todo",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Material selection for housing",
                "project": mech,
                "status": "todo",
                "priority": "medium",
                "task_type": "research",
            ...
            # Optics Project
            {
                "title": "Laser beam collimation design",
                "project": opt,
                "status": "done",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Mount assembly tolerancing",
                "project": opt,
                "status": "in_progress",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Detector sensitivity calibration",
                "project": opt,
                "status": "review",
                "priority": "medium",
                "task_type": "task",
            ...
            # Simulation Project
            {
                "title": "Set up simulation environment",
                "project": sim,
                "status": "done",
                "priority": "high",
                "task_type": "task",
            ...
            {
                "title": "Model thermal behaviour of PCB",
                "project": sim,
                "status": "in_progress",
                "priority": "medium",
                "task_type": "task",
            ...
            {
                "title": "Integrate hardware-in-loop testing",
                "project": sim,
                "status": "todo",
                "priority": "high",
                "task_type": "feature",
        ...
        for td in tasks_data:
            if not Task.objects.filter(
                ...
                assigned_to = td.pop(
                    "assigned_to", None
                )  # Extract assigned_to before create
        ...
        for nd in notifs:
            Notification.objects.get_or_create(
                recipient=nd["recipient"], title=nd["title"], defaults=nd
            )
