...
def download_excel_template(request):
    ...
    # Define headers
    headers = ['Name', 'Category', 'Brand', 'SKU', 'Serial Number', 'Price', 'Description', 'Datasheet Filename', 'Rack Number', 'Shelf Number']
    ...
    # Add sample data row
    sample_data = ['Sample Product', 'Electronics', 'Sample Brand', 'SKU001', 'SN123456', '99.99', 'Sample product description', 'widget2000.pdf', 'A1', 'B2']
            ...
            for index, row in df.iterrows():
                try:
                    ...
                    product = Product.objects.create(
                        ...
                        shelf_number=str(row.get('Shelf Number', '')).strip() if 'Shelf Number' in df.columns and not pd.isna(row.get('Shelf Number')) else '',
