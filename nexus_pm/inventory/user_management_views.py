...
class InventoryUserManagementView(View):
    PERMISSION_FIELDS = [
        'can_access_adjustments_page', 'can_manage_adjustments',
        'can_access_serials_page', 'can_manage_serials',
        'can_access_limits_page', 'can_manage_limits',
        'can_access_alerts_page', 'can_manage_alerts',
        'can_access_rentals_page', 'can_manage_rentals',
        'can_access_shortage_page', 'can_manage_shortage_exports',
    ]
